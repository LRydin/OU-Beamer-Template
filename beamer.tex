...
\begin{ououtline}
  \item<1-> Motivation
  \itemdetails<1-> Why the question matters and what is being investigated.

  \item<2-> Method
  \itemdetails<2-> A compact description of the model, data, or experiment.

  \item<3-> Results
  \itemdetails<3-> The main quantitative findings and their interpretation.

  \item<4-> Discussion
  \itemdetails<4-> Limitations, assumptions, and possible extensions.
\end{ououtline}
...
% ------------------------------------------------------------
\section{Method}
\begin{frame}{Columns and short lists}
...
% ------------------------------------------------------------
\begin{frame}{Back to the default colour}
